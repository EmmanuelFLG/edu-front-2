  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Visão geral da instituição e atalhos para a gestão do dia a dia."
      />

      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <StatCard icon={GraduationCap} label="Alunos" value={contagens?.alunos} loading={!contagens} tone="ink" />
        <StatCard icon={Users} label="Professores" value={contagens?.professores} loading={!contagens} tone="brand" />
        <StatCard icon={School} label="Turmas" value={contagens?.turmas} loading={!contagens} tone="ink" />
        <StatCard icon={BookOpen} label="Disciplinas" value={contagens?.disciplinas} loading={!contagens} tone="amber" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <LinkTile to="/admin/matriculas" icon={ClipboardList} title="Matrículas" description="Vincular alunos às turmas." />
