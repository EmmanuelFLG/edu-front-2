...
import { CalendarCheck, Save, Users2, CheckCheck } from 'lucide-react'
...
export default function PresencasPage() {
  ...
  return (
    <div>
      <PageHeader icon={CalendarCheck} title="Frequência" subtitle="Escolha a turma/disciplina e a data para fazer a chamada." />
