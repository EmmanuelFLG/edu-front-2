...
import { NotebookPen, CalendarCheck, CalendarClock, School, Link2 } from 'lucide-react'
...
export default function ProfessorDashboard() {
  ...
  return (
    <div>
      <PageHeader title={`Olá, ${usuario.nome.split(' ')[0]}`} subtitle="Lance notas, registre frequência e consulte seu horário."/>
