...
import { NotebookPen, Save, Users2 } from 'lucide-react'
...
export default function NotasPage() {
  ...
  return (
    <div>
      <PageHeader icon={NotebookPen} title="Notas" subtitle="Escolha a turma/disciplina e o bimestre para lançar as notas." />
              ...
              {BIMESTRES.map((b) => (
                <button
                  ...
                  className={`rounded-md px-3 py-1.5 text-xs font-semibold transition-colors ${
                    bimestre === b ? 'bg-white text-ink-700 shadow-sm' : 'text-ink-400 hover:text-ink-600'
                  }`}
                >
                  {b}º bim.
                </button>
