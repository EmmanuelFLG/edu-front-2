    ...
    <div className="grid min-h-screen md:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-center overflow-hidden bg-ink-800 px-12 py-10 text-white md:flex">
        ...
        <div className="relative mt-16 max-w-md">
          <h1 className="text-3xl font-bold leading-tight text-white">
            Gestão escolar simples e inteligente.
          </h1>

          <p className="mt-6 text-lg leading-8 text-ink-200">
            Um sistema desenvolvido para facilitar as rotinas acadêmicas e administrativas,
            conectando alunos, professores e coordenação através de uma experiência de uso
            fluida, moderna e intuitiva.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-sm text-ink-400">Use suas credenciais para acesso</p>
