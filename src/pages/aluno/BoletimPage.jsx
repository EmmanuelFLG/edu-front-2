...
export default function BoletimPage() {
  ...
  if (erro) {
    return (
      <EmptyState icon={ScrollText} title="Boletim indisponível" description="Não foi possível carregar seu boletim agora. Verifique se você possui uma matrícula ativa."/>
    )
  }
  ...
  return (
    <div>
      <PageHeader title="Meu boletim" subtitle="Notas, médias, frequência e situação em cada disciplina." />
      ...
      {disciplinas.length === 0 ? (
        <EmptyState icon={ScrollText} title="Nenhuma nota lançada ainda" description="Assim que os professores lançarem notas, elas aparecerão aqui."/>
      ) : (
