...
const NAV = {
  [ROLES.ADMIN]: [
    ...
    { to: '/admin/solicitacoes-matricula', label: 'Solicitações de Matrícula', icon: ClipboardCheck },
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-paper">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        {/* Topbar — Visível apenas no mobile, oculta a partir de telas médias (desktop) */}
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-ink-100 bg-white px-4 md:hidden">
          <button
